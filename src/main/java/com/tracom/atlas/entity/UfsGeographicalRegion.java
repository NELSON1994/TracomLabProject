...
public class UfsGeographicalRegion implements Serializable {
    ...
    public UfsGeographicalRegion(String regionName, String actionStatus, BigDecimal parentIds, BigDecimal tenantIds) {
    }

    public UfsGeographicalRegion(String regionName, String actionStatus, BigDecimal tenantIds) {
    }
