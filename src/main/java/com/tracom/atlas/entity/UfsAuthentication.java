...
public class UfsAuthentication implements Serializable {
    ...
    @Basic(optional = false)
    @GenericGenerator(
            name = "UFS_AUTHENTICATION_SEQ",
            strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @org.hibernate.annotations.Parameter(name = "sequence_name", value = "UFS_AUTHENTICATION_SEQ"),
                    @org.hibernate.annotations.Parameter(name = "initial_value", value = "0"),
                    @org.hibernate.annotations.Parameter(name = "increment_size", value = "1")
            }
    )
    @GeneratedValue(generator = "UFS_AUTHENTICATION_SEQ")
    ...
    @Column(name = "PASSWORD_CHANGE_DATE",insertable = false,updatable = false)
    @Temporal(TemporalType.TIMESTAMP)
